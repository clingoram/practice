 ...
 *
 * 羅馬數字是由I(1)、V(5)、X(10)、L(50)、C(100)、D(500)、M(1000)組成
 * 數字 2 = II
 * 12 = XII
 * 但如果是
 * 數字 4 = IV(5-1=4)、9 = IX(10-1=9)
 * 40 = XL(50-10=40)、90 = XC(100-10=90)
 * 400 = CD(500-100)、900 = CM(1000-100=900)
 * -----------------------------------------------------
 * Hints
